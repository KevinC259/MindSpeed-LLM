...
def get_megatron_optimizer_based_on_param_groups(
    ...
    if param_groups:
        if config.optimizer_cpu_offload:
            ...
            args = get_args()
            if hasattr(args, 'optimizer_selection') and args.optimizer_selection == 'zeta_moon':
                if hasattr(args, 'zeta_momentum'):
                    kwargs["momentum"] = args.zeta_momentum
                if hasattr(args, 'zeta_ns_steps'):
                    kwargs["ns_steps"] = args.zeta_ns_steps
                if hasattr(args, 'zeta_trust_region_threshold'):
                    kwargs["trust_region_threshold"] = args.zeta_trust_region_threshold
