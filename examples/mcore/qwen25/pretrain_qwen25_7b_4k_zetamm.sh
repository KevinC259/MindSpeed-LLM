...
CKPT_LOAD_DIR="/sharedata/ckw/ckpt/qwen2.5-7b-hf-zetamm-max/"
CKPT_SAVE_DIR="/sharedata/ckw/ckpt/qwen2.5-7b-hf-zetamm-max"
...
OPT=$1
EXP_NAME="zeta_moon_qwen25_7b_4k_2.5e-6"
