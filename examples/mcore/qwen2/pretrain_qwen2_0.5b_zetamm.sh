...
CKPT_LOAD_DIR="/sharedata/ckw/ckpt/qwen2.5-0.5b-hf-zetamm-lr1e-3_th1_tanh/"
CKPT_SAVE_DIR="/sharedata/ckw/ckpt/qwen2.5-0.5b-hf-zetamm-lr1e-3_th1_tanh"
DATA_PATH="/sharedata/ckw/dataset/alpaca_text_document"
...
OPT=$1
EXP_NAME="zetamm_qwen25_0.5b_4k_1e-3_th1_tanh"
...
GPT_ARGS="
    ...
    --optimizer-selection zeta_moon \
    --zeta-momentum 0.9 \
    --zeta-trust-region-threshold 1 \
    --bf16
"
