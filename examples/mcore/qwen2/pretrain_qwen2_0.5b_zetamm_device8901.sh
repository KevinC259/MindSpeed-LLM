...
CKPT_LOAD_DIR="/sharedata/ckw/ckpt/qwen2.5-0.5b-hf-adamuon-lr6e-4_openwebtext/"
CKPT_SAVE_DIR="/sharedata/ckw/ckpt/qwen2.5-0.5b-hf-adamuon-lr6e-4_openwebtext"
...
OPT=$1
EXP_NAME="adamuon_qwen25_0.5b_4k_6e-4_openwebtext"
