...
CKPT_LOAD_DIR="/sharedata/ckw/ckpt/qwen2.5-0.5b-hf-soap-lr1e-3/"
CKPT_SAVE_DIR="/sharedata/ckw/ckpt/qwen2.5-0.5b-hf-soap-lr1e-3"
...
OPT=$1
EXP_NAME="soap_qwen25_0.5b_4k_1e-3"
