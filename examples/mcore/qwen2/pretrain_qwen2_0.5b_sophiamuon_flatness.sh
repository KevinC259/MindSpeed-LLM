...
CKPT_LOAD_DIR="/sharedata/ckw/ckpt/qwen2.5-0.5b-hf-sophiamuon_flatness-lr3e-4_openwebtext_480/"
CKPT_SAVE_DIR="/sharedata/ckw/ckpt/qwen2.5-0.5b-hf-sophiamuon_flatness-lr3e-4_openwebtext_480/"
...
OPT=$1
EXP_NAME="sophiamuon_flatness_qwen25_0.5b_4k_3e-4_openwebtext"
...
GPT_ARGS="
    ...
    --optimizer-selection sophiamuonflatness \
    --bf16
"
