...
CKPT_SAVE_DIR="/sharedata/ckw/ckpt/gpt2-small-zetas"
TENSORBOARD_DIR="./tensorboard/gpt2_small_zetas"
WANDB_DIR="./wandb/gpt2_small_zetas"
...
OUTPUT_ARGS="
  ...
  --wandb-exp-name gpt2-small-zetas-100k \
...
torchrun ${DISTRIBUTED_ARGS} pretrain_gpt.py \
  ...
  --save ${CKPT_SAVE_DIR} \
  | tee logs/pretrain_gpt2_small_zetas.log
