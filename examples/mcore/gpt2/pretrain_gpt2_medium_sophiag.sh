...
CKPT_SAVE_DIR="/sharedata/ckw/ckpt/gpt2-medium-sophiag"
TENSORBOARD_DIR="./tensorboard/gpt2_medium_sophiag"
WANDB_DIR="./wandb/gpt2_medium_sophiag"
...
OUTPUT_ARGS="
  ...
  --wandb-exp-name gpt2-medium-sophiag-100k \
...
torchrun ${DISTRIBUTED_ARGS} pretrain_gpt.py \
  ...
  --save ${CKPT_SAVE_DIR} \
  | tee logs/pretrain_gpt2_medium_sophiag.log
