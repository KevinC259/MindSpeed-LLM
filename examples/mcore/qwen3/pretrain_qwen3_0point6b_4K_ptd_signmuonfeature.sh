...
CKPT_LOAD_DIR="/sharedata/ckw/ckpts/qwen3_0.6B_signmuonfeature_lr3e-4_openwebtext/"
CKPT_SAVE_DIR="/sharedata/ckw/ckpts/qwen3_0.6B_signmuonfeature_lr3e-4_openwebtext"
...
PROJECT_DIR="qwen3-0.6b-optimizer"
EXP_NAME="signmuonfeature_qwen3_0.6b_4k_3e-4_openwebtext"
...
GPT_ARGS="
    ...
    --no-load-rng \
    --seed 42 \
    --optimizer-selection signmuonfeature \
    --bf16
"
...
torchrun $DISTRIBUTED_ARGS $pre/pretrain_gpt.py \
    $GPT_ARGS \
    $DATA_ARGS \
    $OUTPUT_ARGS \
    $OPTIMIZE_ARGS \
